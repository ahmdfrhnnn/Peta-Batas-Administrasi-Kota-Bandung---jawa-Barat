...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [765040.671442, 9222577.121423, 818355.350466, 9249591.934837], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32748',
...
map.getView().fit([765040.671442, 9222577.121423, 818355.350466, 9249591.934837], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Batas Administrasi Kota Bandung - Jawa Barat</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (70 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini merupakan batas wilayah administrasi Kota Bandung, Jawa Barat';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_DATA2Kota_BandungADMNew_0,
    colName: 'WADMKC',
    zoom: 10,
    collapsed: true,
    map: map,
